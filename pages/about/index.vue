    ...
    <div class="hero-body">
        <div class="container">
            <div class="content paragraph-double-space-after">
                ...
                <p>Hello! I am StahlFerro - I am both a youtube VFX Composite-Animations content creator and a software developer</p>
                <p><strong>&gt; VFX Composite-Animations</strong><br/>
                    ...
                    static images, both combined to produce a hybrid form of animation that displays an intense visual graphic experience. Most of my
                    main works are uploaded as videos on youtube, but I also make short GIFs and animations posted on my Imgur account
                </p>
                <p><strong>&gt; Software Developer</strong><br/>
                    I'm the sole developer of the Discord moderation bot FortressBot, a bot made with auto-moderative features.
