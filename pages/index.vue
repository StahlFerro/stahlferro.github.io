<template>
  <div>
    <section
      ...
      style="background-image: url('/static/img/Duality.png');">
    ...
    <section class="hero is-medium is-dark-2">
      <div class="hero-body">
        <div class="container">
          <div class="content">
            <h1 class="title is-1">Creator | Developer | Video Compositor</h1>
            <p>I create hybrid vfx/composited parody videos and develop various interesting softwares.</p>
            <p>
              On this website, you will find my projects on both Videos and Softwares that I'm currently working on.
